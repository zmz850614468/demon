...
import Data_P_10_2023 from './Data_P_10_2023'
...
export default class DataParse_P_10 {
  ...
  constructor() {
    DataParse_P_10.basicList = DataParse_P_10.basicList.concat(DataParse_P_10.basicList, new Data_P_10_2023().getBasicList())
  }
