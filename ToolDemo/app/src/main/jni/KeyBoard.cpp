...
#include <jni.h>            // jni 对应的操作方法
#include <sys/types.h>      // 定义的各种数据类型
#include <sys/stat.h>       // 定义文件状态所在的伪标准头文件：获得文件的所有信息
            ...
            if (event.type == EV_KEY)
                if (event.value == 0)// || event.value==1
                {
                    if (event.code == KEY_ESC) {
                        ...
                        switch (event.code) {
                            case KEY_A:
                                InputString[InputStringPc++] = 'A';
                                break;
                            case KEY_B:
                                InputString[InputStringPc++] = 'B';
                                break;
                            case KEY_C:
                                InputString[InputStringPc++] = 'C';
                                break;
                            case KEY_D:
                                InputString[InputStringPc++] = 'D';
                                break;
                            case KEY_E:
                                InputString[InputStringPc++] = 'E';
                                break;
                            case KEY_F:
                                InputString[InputStringPc++] = 'F';
                                break;
                            case KEY_G:
                                InputString[InputStringPc++] = 'G';
                                break;
                            case KEY_H:
                                InputString[InputStringPc++] = 'H';
                                break;
                            case KEY_I:
                                InputString[InputStringPc++] = 'I';
                                break;
                            case KEY_J:
                                InputString[InputStringPc++] = 'J';
                                break;
                            case KEY_K:
                                InputString[InputStringPc++] = 'K';
                                break;
                            case KEY_L:
                                InputString[InputStringPc++] = 'L';
                                break;
                            case KEY_M:
                                InputString[InputStringPc++] = 'M';
                                break;
                            case KEY_N:
                                InputString[InputStringPc++] = 'N';
                                break;
                            case KEY_O:
                                InputString[InputStringPc++] = 'O';
                                break;
                            case KEY_P:
                                InputString[InputStringPc++] = 'P';
                                break;
                            case KEY_Q:
                                InputString[InputStringPc++] = 'Q';
                                break;
                            case KEY_R:
                                InputString[InputStringPc++] = 'R';
                                break;
                            case KEY_S:
                                InputString[InputStringPc++] = 'S';
                                break;
                            case KEY_T:
                                InputString[InputStringPc++] = 'T';
                                break;
                            case KEY_U:
                                InputString[InputStringPc++] = 'U';
                                break;
                            case KEY_V:
                                InputString[InputStringPc++] = 'V';
                                break;
                            case KEY_W:
                                InputString[InputStringPc++] = 'W';
                                break;
                            case KEY_X:
                                InputString[InputStringPc++] = 'X';
                                break;
                            case KEY_Y:
                                InputString[InputStringPc++] = 'Y';
                                break;
                            case KEY_Z:
                                InputString[InputStringPc++] = 'Z';
                                break;
                        }
...
Java_android_1keyboard_1listen_KeyBoard_Start_1KeyBoard(JNIEnv *env, jobject, jstring path) {
...
Java_android_1keyboard_1listen_KeyBoard_Get_1Input(JNIEnv *env, jobject) {
    if (InputFlag == false) {
            ...
            if (event.type == EV_KEY)
                if (event.value == 0)// || event.value==1
                {
                    if (event.code == KEY_ESC) {
                        ...
                        switch (event.code) {
                            case KEY_A:
                                InputString3[InputStringPc3++] = 'A';
                                break;
                            case KEY_B:
                                InputString3[InputStringPc3++] = 'B';
                                break;
                            case KEY_C:
                                InputString3[InputStringPc3++] = 'C';
                                break;
                            case KEY_D:
                                InputString3[InputStringPc3++] = 'D';
                                break;
                            case KEY_E:
                                InputString3[InputStringPc3++] = 'E';
                                break;
                            case KEY_F:
                                InputString3[InputStringPc3++] = 'F';
                                break;
                            case KEY_G:
                                InputString3[InputStringPc3++] = 'G';
                                break;
                            case KEY_H:
                                InputString3[InputStringPc3++] = 'H';
                                break;
                            case KEY_I:
                                InputString3[InputStringPc3++] = 'I';
                                break;
                            case KEY_J:
                                InputString3[InputStringPc3++] = 'J';
                                break;
                            case KEY_K:
                                InputString3[InputStringPc3++] = 'K';
                                break;
                            case KEY_L:
                                InputString3[InputStringPc3++] = 'L';
                                break;
                            case KEY_M:
                                InputString3[InputStringPc3++] = 'M';
                                break;
                            case KEY_N:
                                InputString3[InputStringPc3++] = 'N';
                                break;
                            case KEY_O:
                                InputString3[InputStringPc3++] = 'O';
                                break;
                            case KEY_P:
                                InputString3[InputStringPc3++] = 'P';
                                break;
                            case KEY_Q:
                                InputString3[InputStringPc3++] = 'Q';
                                break;
                            case KEY_R:
                                InputString3[InputStringPc3++] = 'R';
                                break;
                            case KEY_S:
                                InputString3[InputStringPc3++] = 'S';
                                break;
                            case KEY_T:
                                InputString3[InputStringPc3++] = 'T';
                                break;
                            case KEY_U:
                                InputString3[InputStringPc3++] = 'U';
                                break;
                            case KEY_V:
                                InputString3[InputStringPc3++] = 'V';
                                break;
                            case KEY_W:
                                InputString3[InputStringPc3++] = 'W';
                                break;
                            case KEY_X:
                                InputString3[InputStringPc3++] = 'X';
                                break;
                            case KEY_Y:
                                InputString3[InputStringPc3++] = 'Y';
                                break;
                            case KEY_Z:
                                InputString3[InputStringPc3++] = 'Z';
                                break;
                        }
                    } else if (event.code == KEY_MINUS) {
...
extern "C" JNIEXPORT void JNICALL
Java_android_1keyboard_1listen_KeyBoard_Start_1KeyBoard3(JNIEnv *env, jobject, jstring path) {
    PathString3 = env->GetStringUTFChars(path, NULL);
    pthread_create(&MyPthread3, NULL, pthread_read_keyboard3, NULL);
}

extern "C" JNIEXPORT jstring JNICALL
Java_android_1keyboard_1listen_KeyBoard_Get_1Input3(JNIEnv *env, jobject) {
    if (InputFlag3 == false) {
        const char *tmpstr = "null";
        jstring rtstr = env->NewStringUTF(tmpstr);
        return rtstr;
            ...
            if (event.type == EV_KEY)
                if (event.value == 0)// || event.value==1
                {
                    if (event.code == KEY_ESC) {
                        ...
                        switch (event.code) {
                            case KEY_A:
                                InputString4[InputStringPc4++] = 'A';
                                break;
                            case KEY_B:
                                InputString4[InputStringPc4++] = 'B';
                                break;
                            case KEY_C:
                                InputString4[InputStringPc4++] = 'C';
                                break;
                            case KEY_D:
                                InputString4[InputStringPc4++] = 'D';
                                break;
                            case KEY_E:
                                InputString4[InputStringPc4++] = 'E';
                                break;
                            case KEY_F:
                                InputString4[InputStringPc4++] = 'F';
                                break;
                            case KEY_G:
                                InputString4[InputStringPc4++] = 'G';
                                break;
                            case KEY_H:
                                InputString4[InputStringPc4++] = 'H';
                                break;
                            case KEY_I:
                                InputString4[InputStringPc4++] = 'I';
                                break;
                            case KEY_J:
                                InputString4[InputStringPc4++] = 'J';
                                break;
                            case KEY_K:
                                InputString4[InputStringPc4++] = 'K';
                                break;
                            case KEY_L:
                                InputString4[InputStringPc4++] = 'L';
                                break;
                            case KEY_M:
                                InputString4[InputStringPc4++] = 'M';
                                break;
                            case KEY_N:
                                InputString4[InputStringPc4++] = 'N';
                                break;
                            case KEY_O:
                                InputString4[InputStringPc4++] = 'O';
                                break;
                            case KEY_P:
                                InputString4[InputStringPc4++] = 'P';
                                break;
                            case KEY_Q:
                                InputString4[InputStringPc4++] = 'Q';
                                break;
                            case KEY_R:
                                InputString4[InputStringPc4++] = 'R';
                                break;
                            case KEY_S:
                                InputString4[InputStringPc4++] = 'S';
                                break;
                            case KEY_T:
                                InputString4[InputStringPc4++] = 'T';
                                break;
                            case KEY_U:
                                InputString4[InputStringPc4++] = 'U';
                                break;
                            case KEY_V:
                                InputString4[InputStringPc4++] = 'V';
                                break;
                            case KEY_W:
                                InputString4[InputStringPc4++] = 'W';
                                break;
                            case KEY_X:
                                InputString4[InputStringPc4++] = 'X';
                                break;
                            case KEY_Y:
                                InputString4[InputStringPc4++] = 'Y';
                                break;
                            case KEY_Z:
                                InputString4[InputStringPc4++] = 'Z';
                                break;
                        }
                    } else if (event.code == KEY_MINUS) {
...
extern "C" JNIEXPORT void JNICALL
Java_android_1keyboard_1listen_KeyBoard_Start_1KeyBoard4(JNIEnv *env, jobject, jstring path) {
    PathString4 = env->GetStringUTFChars(path, NULL);
    pthread_create(&MyPthread4, NULL, pthread_read_keyboard4, NULL);
}

extern "C" JNIEXPORT jstring JNICALL
Java_android_1keyboard_1listen_KeyBoard_Get_1Input4(JNIEnv *env, jobject) {
    if (InputFlag4 == false) {
        const char *tmpstr = "null";
        jstring rtstr = env->NewStringUTF(tmpstr);
        return rtstr;
