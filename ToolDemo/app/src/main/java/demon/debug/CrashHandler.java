...
//        sendErrorLog(sendNetUrl);
    ...
    private void saveErrorLog() {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            ...
            // 写日志到文件中去
            String dir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS) + "/agvDebug";
            File file = FileUtil.createIfNotExit(dir, format);
            if (file != null && file.canWrite()) {
                FileUtil.appendFile(file.getAbsoluteFile(), mErrorLogBuffer.toString());
            }
