...
public class BleCommunicateAdapter extends RecyclerView.Adapter<BleCommunicateAdapter.AccountHolder> {

    private Context context;
    private List<String> beanList;
    private int selectedInde;

    public BleCommunicateAdapter(Context context, List<String> list) {
    ...
    public AccountHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_ble_communicate, viewGroup, false);
