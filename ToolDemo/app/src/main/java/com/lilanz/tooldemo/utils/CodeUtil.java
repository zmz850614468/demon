...
//            im1.setImageBitmap(bitmap);
     ...
     * @throws WriterException WriterException异常
     */
    public static Bitmap createEan13Code(String content, int w, int h) throws WriterException {
        BitMatrix matrix = new MultiFormatWriter().encode(content, BarcodeFormat.EAN_13, w, h);
