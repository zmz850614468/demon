...
public class DaoExaActivity extends Activity {
    ...
    private void initSearch() {
        ...
        btSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BeanDao dao = BeanDao.getDaoOperate(DaoExaActivity.this, StudentBean.class);
                StudentBean bean = (StudentBean) dao.queryWhereForOne(map);
                if (bean == null) {
    ...
    private void initInsert() {
        ...
        btInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!StringUtil.isEmpty(ageStr) && NumberUtil.isInteger(ageStr)) {
                    bean.age = Integer.parseInt(ageStr);
                }
                if (!StringUtil.isEmpty(isBoyStr) && NumberUtil.isInteger(isBoyStr)) {
    ...
    private void searchAll() {
        tvAll.setText("");
        BeanDao dao = BeanDao.getDaoOperate(this, StudentBean.class);
        List<StudentBean> list = dao.queryAll();
