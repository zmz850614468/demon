...
import com.lilanz.foodie.bean.Bean;
...
public class OrmLiteHelter extends OrmLiteSqliteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database, ConnectionSource connectionSource) {
        try {
            TableUtils.createTable(connectionSource, FoodTypeBean.class);
            TableUtils.createTable(connectionSource, MaterialBean.class);
            TableUtils.createTable(connectionSource, FoodBean.class);
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
    }
    ...
    public void onUpgrade(SQLiteDatabase database, ConnectionSource connectionSource, int oldVersion, int newVersion) {
        try {
            TableUtils.dropTable(connectionSource, FoodTypeBean.class, true);
            TableUtils.dropTable(connectionSource, MaterialBean.class, true);
            TableUtils.dropTable(connectionSource, FoodBean.class, true);
