package com.demon.dream_realizer_car.daos;
...
public class OrmLiteHelter extends OrmLiteSqliteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database, ConnectionSource connectionSource) {
        try {
            TableUtils.createTable(connectionSource, RouteBean.class);
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
    }
    ...
    public void onUpgrade(SQLiteDatabase database, ConnectionSource connectionSource, int oldVersion, int newVersion) {
        try {
            TableUtils.dropTable(connectionSource, RouteBean.class, true);
