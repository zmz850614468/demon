...
public class MediaFile {
     ...
     * @return
     */
    public static ContentValues getVideoContentValues(Context paramContext, File file, long currentTime) {
        ContentValues localContentValues = new ContentValues();
        localContentValues.put("title", file.getName());
        localContentValues.put("_display_name", file.getName());
        localContentValues.put("mime_type", "video/mp4");
        localContentValues.put("datetaken", Long.valueOf(currentTime));
        localContentValues.put("date_modified", Long.valueOf(currentTime));
        localContentValues.put("date_added", Long.valueOf(currentTime));
