...
public interface SlidingActivityBase {
	...
	/**
	 * Open the SlidingMenu and show the layout_menu view.
	 */
	public void showMenu();

	/**
	 * Open the SlidingMenu and show the secondary (right) layout_menu view. Will default to the regular layout_menu
	 * if there is only one.
	 */
	public void showSecondaryMenu();
	
	/**
	 * Controls whether the ActionBar slides along with the above view when the layout_menu is opened,
