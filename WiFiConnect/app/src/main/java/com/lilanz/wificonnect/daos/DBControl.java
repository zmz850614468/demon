package com.lilanz.wificonnect.daos;
...
public class DBControl {
    ...
    public static void createOrUpdateList(Context context, Class clazz, List list) {
        BeanDao dao = BeanDao.getDaoOperate(context, clazz);
        for (Object o : list) {
            dao.update(o);
        }
    ...
    public static void deleteAll(Context context, Class clazz, List list) {
        BeanDao dao = BeanDao.getDaoOperate(context, clazz);
        for (Object o : list) {
            dao.delete(o);
        }
